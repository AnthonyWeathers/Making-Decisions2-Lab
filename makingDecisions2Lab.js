...
for (let i = 0; i < listOfNumbers.length; i++) {
    if (listOfNumbers[i] % 3 === 0) {
      console.log(`${listOfNumbers[i]} is divisible by 3.`) // can also do console.log(listOfNumbers[i], 'is divisible by 3.')
    } // accidentally did {number}, from copy and paste, then did {i} and not get the indexed value
}
////////// PROBLEM 9 //////////
// Do not edit the code below.
